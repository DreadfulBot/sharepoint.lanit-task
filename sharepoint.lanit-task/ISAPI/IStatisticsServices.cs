...
namespace sharepoint.lanit_task.Services
{
    ...
    interface IStatisticsServices
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, UriTemplate = "GetUserStatistics/{userLogin}")]
        List<StatisticsItem> GetUserStatistics(string userLogin);
